...
export default function () {
  return (site: Lume.Site) => {
    ...
    const files = [
      ...
      "_includes/styles/ui/navbar-float.css",
      "_includes/styles/ui/navbar-flexible.css",
      ...
      "_includes/templates/navbar-float.vto",
      "_includes/templates/navbar-flexible.vto",
